...
## 함수 선언 부분 ##
def  loadImage(fname) :
    global window, canvas, paper, filename, XSIZE, YSIZE, inImage, inImage2 ,filename
...
def randomPhoto() :
    global window, canvas, paper, filename, XSIZE, YSIZE, inImage, filename, addValue, inImage2
    addValue = random.randint(0, 255)
...
if __name__ == "__main__" :
    ...
    photoMenu.add_command(label="랜덤으로 명암", command=randomPhoto)
    window.mainloop()
